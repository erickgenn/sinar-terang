...
<head>
    ...
    <title>Sinar Terang | Contact Us Page</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Contact Us Page Configuration</h1>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive" style="align-content:flex-end">
                            <table id="contactus-table" class="table table-striped table-bordered table-sm" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Phone</th>
    ...
    <script>
        $(document).ready(function() {
            $('#contactus-table').DataTable({
                scrollX: true,
                "ajax": {
                    "url": "<?php echo base_url('admin/customer_pages/contact_us/search'); ?>",
                    "dataSrc": ""
                },
                "columns": [{
                        searchable: false,
                    ...
                    },
                    {
                        ...
                        sortable: false,
                        render: function(data, type, row, meta) {
                            return `<a href="<?php echo base_url('admin/customer_pages/contact_us/view') ?>/${row.id}" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a>
                                    `;
                        }
                    },
                ]
