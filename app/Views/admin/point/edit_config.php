...
<head>
    ...
    <title>Sinar Terang | Edit Points Configuration</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo base_url("/admin/point/config"); ?>">Points Configuration</a></li>
                                <li class="breadcrumb-item active">Edit Points Configuration</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    <section class="content">
                        <form method="POST" action="<?php echo base_url('admin/point/edit_config') . '/' . $id ?>" name="faq_form">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="inputDescription" name="point_description" class="form-control"><?php echo $point['description']; ?></textarea>
                                            </div>
                                            <label for="inputPoint">Point Value</label>

                                            <div class="row">
                                                <div class="col-2">
                                                    <input type="number" id="inputPoint" name="point_point" class="form-control" value="<?php echo $point['point']; ?>">
                                                </div>
                                                <h2>=</h2>
                                                <div class="col-2">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" id="inputValue" name="point_value" class="form-control" value="<?php echo $point['value']; ?>">
                                                    </div>
                                                </div>
                                            </div>
