...
<head>
    ...
    <title>Sinar Terang | Electrical Expenses Report</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Electrical Expenses Report</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo base_url("/admin/dashboard"); ?>">Dashboard</a></li>
                                <li class="breadcrumb-item active">Electrical Expenses Report</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive" style="align-content:flex-end">
                            <table id="electrical-table" class="table table-striped table-bordered table-sm" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Date</th>
    ...
    <script>
        function generateTable() {
            ...
            if ($('#month').val() === "") {
                ...
                let tabel = $('#electrical-table').DataTable();
                tabel.destroy();
                $('#electrical-table').DataTable({
                    dom: 'Bfrtip',
                    buttons: [{
                            extend: 'copyHtml5',
                            footer: true
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('admin/finance/electrical/search'); ?>",
                        "data": {
                            month: $('#month').val(),
                        },
                        "dataSrc": ""
    ...
    <script>
        function getTotal() {
            $.ajax({
                url: "<?php echo base_url('admin/finance/electrical/search/total'); ?>",
                "data": {
                    month: $('#month').val(),
                },
