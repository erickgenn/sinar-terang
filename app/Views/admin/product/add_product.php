                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="inputQuantity" name="product_quantity" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="inputDescription" name="product_description" class="form-control">
                                            </div>
                                            <div class="form-group">
